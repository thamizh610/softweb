        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(255, 255, 255, 0.75),rgba(54, 52, 52, 0.75));
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(251, 251, 251, 0.75),rgba(79, 76, 76, 0.75));
                background-size: cover;
                background-position: center;
            }
            .navbar {
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(241, 241, 241, 0.75),rgba(81, 77, 79, 0.75));
                background-size: cover;
                background-position: center;
            }
            .navbar {
    ...
    <div class="banner">
        ...
        <div class="image">
            <table cellspacing="20"> 
                <tr align="center">
                    <td> <img src="person1.webp"> </td>
                    <td> <img src="person2.webp"></td>
                    <td> <img src="person3.jpg"> </td>
                    <td> <img src="person4.webp"> </td>
                    <td> <img src="person5.jpg"> </td>
                </tr>
                <tr align="center">
                    <th> THALA</th>
                    <th> STR</th>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(255, 254, 255, 0.75),rgba(0, 0, 0, 0.75));
                background-size: cover;
                background-position: center;
            }
            .navbar {
    ...
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                ...
                <p> <span>Address</span> : 48/mkjij naaafej  jnd>
                <p> <span>Email</span> : nckjsc@gmail.com </p>
                <p> <span>Phone</span> : 5464565456 </p>
            </div>
        </div>
    </div>
...
## OUTPUT:
![w7o1](https://github.com/thamizh610/softweb/assets/150418511/5508d0eb-c73e-4350-8c40-3b6c4ce45dba)

![w7o2](https://github.com/thamizh610/softweb/assets/150418511/2110ebe3-180e-41e6-bf8c-9ea614704e2d)

![w7o3](https://github.com/thamizh610/softweb/assets/150418511/59df6c42-524f-4109-a4ab-144dc09beacf)

![w7o4](https://github.com/thamizh610/softweb/assets/150418511/868b328f-851a-4566-853f-942ac2540941)
